在《Unix[网络编程](https://so.csdn.net/so/search?q=网络编程&spm=1001.2101.3001.7020)》一书中提到了五种IO模型，分别是：阻塞IO、非阻塞IO、多路复用IO、信号驱动IO以及异步IO。
1、阻塞IO模型
...
![img](https://images2015.cnblogs.com/blog/249993/201703/249993-20170310143514279-1156251223.jpg)
